...
/// 账号是否填充
@property (nonatomic, readonly, strong) EZRMutableNode *accountFieldNode;

/// 密码是否填充
@property (nonatomic, readonly, strong) EZRMutableNode *pwdFieldNode;

/// 保存密码是否打开
@property (nonatomic, readonly, strong) EZRMutableNode *rmbPwdNode;

/// 自动登录是否打开
@property (nonatomic, readonly, strong) EZRMutableNode *autoLoginNode;

/// 按钮能否点击
@property (nonatomic, readonly, strong) EZRMutableNode *validLoginNode;
